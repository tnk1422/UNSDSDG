module.exports = {
    ...
    input: {
        title: "__v1__sdg__goal__dataget",
        type: "object",
        properties: {
            "goal": {
                "title": "goal",
                "displayTitle": "Goal",
                "type": "array",
                "description": "List of codes for the Goals we are queying",
                "items": {
                    "type": "string",
                    "title": "goal",
                    "description": ""
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Goal/Data`;
