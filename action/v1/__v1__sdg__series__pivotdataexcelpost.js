module.exports = {
    ...
    name: "__v1__sdg__series__pivotdataexcelpost",

    title: "Returns a pivoted excel file",
    ...
    input: {
        title: "__v1__sdg__series__pivotdataexcelpost",
        type: "object",
        properties: {
            "seriesCodes": {
                "title": "seriesCodes",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Series/PivotDataExcel`;
