module.exports = {
    ...
    name: "__v1__sdg__goal__goalcode__target__listget",

    title: "Returns the list of all Targets available for a Goal.",
    ...
    input: {
        title: "__v1__sdg__goal__goalcode__target__listget",
        type: "object",
        properties: {
            "includechildren": {
            ...
            "goalCode": {
                ...
                "type": "string",
                "description": "Code of the goal that we are querying",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Goal/"+input.goalCode+"/Target/List";
