module.exports = {
    ...
    name: "__v1__sdg__target__targetcode__geoareasget",

    title: "Returns a list of geographies that have values on that Target",
    ...
    input: {
        title: "__v1__sdg__target__targetcode__geoareasget",
        type: "object",
        properties: {
            "targetCode": {
                "title": "targetCode",
                ...
                "type": "string",
                "description": "Code for that target",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Target/"+input.targetCode+"/GeoAreas";
