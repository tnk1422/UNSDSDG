module.exports = {
    ...
    name: "__v1__sdg__series__seriescode__dimensionsget",

    title: "Returns a list of dimensions for a series",
    ...
    input: {
        title: "__v1__sdg__series__seriescode__dimensionsget",
        type: "object",
        properties: {
            "seriesCode": {
                "title": "seriesCode",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Series/"+input.seriesCode+"/Dimensions";
