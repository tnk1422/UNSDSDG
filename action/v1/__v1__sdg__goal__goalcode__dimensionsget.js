module.exports = {
    ...
    name: "__v1__sdg__goal__goalcode__dimensionsget",
    ...
    input: {
        title: "__v1__sdg__goal__goalcode__dimensionsget",
        type: "object",
        properties: {
            "goalCode": {
                "title": "goalCode",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Goal/"+input.goalCode+"/Dimensions";
