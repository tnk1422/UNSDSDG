module.exports = {
    ...
    name: "__v1__sdg__series__seriescode__attributesget",
    ...
    input: {
        title: "__v1__sdg__series__seriescode__attributesget",
        type: "object",
        properties: {
            "seriesCode": {
                "title": "seriesCode",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Series/"+input.seriesCode+"/Attributes";
