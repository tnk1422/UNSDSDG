module.exports = {
    ...
    name: "__v1__sdg__target__targetcode__indicator__listget",

    title: "Returns the list of all Indicators available for a Target.",
    ...
    input: {
        title: "__v1__sdg__target__targetcode__indicator__listget",
        type: "object",
        properties: {
            "includechildren": {
            ...
            "targetCode": {
                "title": "targetCode",
                "displayTitle": "TargetCode",
                "type": "string",
                "description": "Code of the target that we are querying",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Target/"+input.targetCode+"/Indicator/List";
