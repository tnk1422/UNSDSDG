module.exports = {
    ...
    name: "__v1__sdg__target__dataget",
    ...
    input: {
        title: "__v1__sdg__target__dataget",
        type: "object",
        properties: {
            "target": {
                "title": "target",
                "displayTitle": "Target",
                "type": "array",
                "description": "List of codes for the targets we are queying",
                "items": {
                    "type": "string",
                    "title": "target",
                    "description": ""
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Target/Data`;
