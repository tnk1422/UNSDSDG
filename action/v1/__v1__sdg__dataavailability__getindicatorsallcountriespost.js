module.exports = {
    ...
    name: "__v1__sdg__dataavailability__getindicatorsallcountriespost",

    title: "Returns list of Compare indicators across all goals for given geoareas",

    version: "v1",

    description: "ReturnslistofCompareindicatorsacrossallgoalsforgivengeoareas",
    //Added after creating the Action from swagger
    mock_input: {

    },
    input: {
        title: "__v1__sdg__dataavailability__getindicatorsallcountriespost",
        type: "object",
        properties: {
            "dataPointType": {
                "title": "dataPointType",
            ...
            "countryId": {
                "title": "countryId",
                "displayTitle": "CountryId",
                "type": "string",
                "description": "country code (int) e.g 0 for all countries",
                "required": true,
                "minLength": 1
            },
            "natureOfData": {
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/DataAvailability/GetIndicatorsAllCountries`;
