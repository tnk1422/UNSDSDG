module.exports = {
    ...
    name: "__v1__sdg__series__datacountpost",

    title: "Returns a count of data points for series and areacodes",
    ...
    input: {
        title: "__v1__sdg__series__datacountpost",
        type: "object",
        properties: {
            "seriesCodes": {
                "title": "seriesCodes",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Series/DataCount`;
