module.exports = {
    ...
    name: "__v1__sdg__indicator__indicatorcode__geoareasget",

    title: "Returns a list of geographies that have values on that Indicator",
    ...
    input: {
        title: "__v1__sdg__indicator__indicatorcode__geoareasget",
        type: "object",
        properties: {
            "indicatorCode": {
                "title": "indicatorCode",
                ...
                "type": "string",
                "description": "Code for that indicator",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Indicator/"+input.indicatorCode+"/GeoAreas";
