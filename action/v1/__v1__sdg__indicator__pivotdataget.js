module.exports = {
    ...
    name: "__v1__sdg__indicator__pivotdataget",
    ...
    input: {
        title: "__v1__sdg__indicator__pivotdataget",
        type: "object",
        properties: {
            "indicator": {
                "title": "indicator",
                ...
                "type": "array",
                "description": "List of codes for the indicator we are querying",
                "items": {
                    "type": "string",
                    "title": "indicator",
                    "description": ""
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Indicator/PivotData`;
