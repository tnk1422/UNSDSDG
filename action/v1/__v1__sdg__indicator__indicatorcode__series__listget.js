module.exports = {
    ...
    name: "__v1__sdg__indicator__indicatorcode__series__listget",

    title: "Returns the list of all series for an indincator code",
    ...
    input: {
        title: "__v1__sdg__indicator__indicatorcode__series__listget",
        type: "object",
        properties: {
            "indicatorCode": {
                "title": "indicatorCode",
                "displayTitle": "IndicatorCode",
                "type": "string",
                "description": "Code of the indicator that we are querying",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Indicator/"+input.indicatorCode+"/Series/List";
