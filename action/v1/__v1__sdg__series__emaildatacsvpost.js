module.exports = {
    ...
    name: "__v1__sdg__series__emaildatacsvpost",

    title: "Returns a csv file",
    ...
    input: {
        title: "__v1__sdg__series__emaildatacsvpost",
        type: "object",
        properties: {
            "seriesCodes": {
                "title": "seriesCodes",
            ...
            "email": {
                ...
                "displayTitle": "Email",
                "type": "string",
                "description": "Email to which the link will be send"
            },
            "firstname": {
                "title": "firstname",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Series/EmailDataCSV`;
