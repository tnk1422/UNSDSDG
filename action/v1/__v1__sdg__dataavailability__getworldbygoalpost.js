module.exports = {
    ...
    name: "__v1__sdg__dataavailability__getworldbygoalpost",

    title: "Returns data for Global Summary Of the World for the Mixed line and bar Chart",

    version: "v1",

    description: "ReturnsdataforGlobalSummaryOftheWorldfortheMixedlineandbarChart",
    //Added after creating the Action from swagger
    mock_input: {

    },
    input: {
        title: "__v1__sdg__dataavailability__getworldbygoalpost",
        type: "object",
        properties: {
            "dataPointType": {
                "title": "dataPointType",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/DataAvailability/GetWorldbyGoal`;
