module.exports = {
    ...
    name: "__v1__sdg__target__pivotdataget",
    ...
    input: {
        title: "__v1__sdg__target__pivotdataget",
        type: "object",
        properties: {
            "target": {
                "title": "target",
                "displayTitle": "Target",
                "type": "array",
                "description": "List of codes for the targets we are querying",
                "items": {
                    "type": "string",
                    "title": "target",
                    "description": ""
    ...
    execute: async function(input, output) {
        ...
        option.json = true;
        option.qs = {};
        if (input["target"]) option.qs["target"] = input["target"];
        ...
        option.url = config.url + `/v1/sdg/Target/PivotData`;
