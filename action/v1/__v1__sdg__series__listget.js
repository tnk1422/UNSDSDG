module.exports = {
    ...
    name: "__v1__sdg__series__listget",

    title: "Returns the list of all Series available",
    ...
    input: {
        title: "__v1__sdg__series__listget",
        type: "object",
        properties: {
            "allreleases": {
                "title": "allreleases",
                ...
                "type": "boolean",
                "description": "Includes older releases",
                "required": true,
                "minLength": 1
            }
        }
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/Series/List`;
