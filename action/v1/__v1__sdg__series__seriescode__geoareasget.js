module.exports = {
    ...
    name: "__v1__sdg__series__seriescode__geoareasget",

    title: "Returns a list of geographies that have values on that series",
    ...
    input: {
        title: "__v1__sdg__series__seriescode__geoareasget",
        type: "object",
        properties: {
            "seriesCode": {
                "title": "seriesCode",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + "/v1/sdg/Series/"+input.seriesCode+"/GeoAreas";
