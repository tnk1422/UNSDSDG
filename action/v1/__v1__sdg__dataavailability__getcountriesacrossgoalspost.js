module.exports = {
    ...
    name: "__v1__sdg__dataavailability__getcountriesacrossgoalspost",

    title: "Returns list of Compare countries data across all goals",

    version: "v1",

    description: "ReturnslistofComparecountriesdataacrossallgoals",
    //Added after creating the Action from swagger
    mock_input: {

    },
    input: {
        title: "__v1__sdg__dataavailability__getcountriesacrossgoalspost",
        type: "object",
        properties: {
            "dataPointType": {
                "title": "dataPointType",
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/DataAvailability/GetCountriesAcrossGoals`;
