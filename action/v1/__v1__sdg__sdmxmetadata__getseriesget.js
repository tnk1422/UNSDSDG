module.exports = {
    ...
    name: "__v1__sdg__sdmxmetadata__getseriesget",

    title: "V1SdgSDMXMetadataGetSeriesGet",
    ...
    input: {
        title: "__v1__sdg__sdmxmetadata__getseriesget",
        type: "object",
        properties: {}
    },
    ...
    execute: async function(input, output) {
        ...
        option.url = config.url + `/v1/sdg/SDMXMetadata/GetSeries`;
